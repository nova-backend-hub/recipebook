...
export const RecipeCreateSchema = z.object({
  ...
  prepTime: z.number().int().nonnegative().default(0), // in minutes
  cookTime: z.number().int().nonnegative().default(0), // in minutes
...
// ==========================================
// INTELLECTUAL ENHANCEMENT ENUMS & SCHEMAS
// ==========================================
...
export interface ScaledRecipe {
  ...
  scaleFactor: number;
  ingredients: string[]; // Scaled ingredients text (e.g. "2 cups of flour" -> "4 cups of flour")
}

// ==========================================
// ADMIN DASHBOARD SCHEMAS & TYPES
// ==========================================
